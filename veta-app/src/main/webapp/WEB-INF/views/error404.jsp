...
<div style="text-align:center;padding:80px 24px">
  <div style="font-size:5rem;margin-bottom:20px"><i class="fas fa-magnifying-glass"></i></div>
  ...
  <a href="${pageContext.request.contextPath}/home" class="btn btn-primary"><i class="fas fa-arrow-left"></i> Go to Home</a>
</div>
